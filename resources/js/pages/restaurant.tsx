...
import { home as pixelPerfectHome } from '@/routes';
import {
    gallery as restaurantGallery,
    home as restaurantHome,
    menu as restaurantMenu,
        ...
        <div className="restaurant">
            ...
            <header className="restaurant-header">
                ...
                >
                    ...
                    <Link
                        href={pixelPerfectHome()}
                        className="restaurant-site-link"
                        onClick={() => setMobileOpen(false)}
                    >
                        Pixel Perfect
            ...
            {view === 'home' ? (
                ...
                >
                    ...
                    <div className="footer-bottom">
                        <p>
                            © {new Date().getFullYear()} Restaurante Pixel
                            Perfect. Todos los derechos reservados.
                        </p>
                        <nav aria-label="Navegación del pie de página">
                            <Link href={restaurantHome()}>Inicio</Link>
                            <Link href={restaurantMenu()}>Menú</Link>
                            <Link href={restaurantGallery()}>Galería</Link>
                            <Link href={pixelPerfectHome()}>Pixel Perfect</Link>
                        </nav>
                    </div>
                </section>
            ) : null}
            ...
            <Dialog open={contactOpen} onOpenChange={setContactOpen}>
                <DialogContent className="restaurant-contact">
                    ...
                    <div className="contact-notice">
                        <MessageCircle />
                        <p>
                            Cuéntanos qué te gustó de esta demo y te ayudamos a
                            adaptarla para tu restaurante.
                        </p>
                    </div>
                    ...
                    <div className="restaurant-contact-actions">
                        ...
                        <a className="restaurant-button" href={demoEmailHref}>
                            Contactar por correo
                            <ArrowRight size={18} />
                        </a>
                    </div>
                    <Link
                        className="restaurant-contact-menu-link"
                        href={restaurantMenu()}
                    >
                        Explorar el menú
                        <ArrowRight size={18} />
